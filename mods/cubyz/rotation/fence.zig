...
pub fn updateData(block: *Block, neighbor: Neighbor, neighborBlock: Block) bool {
	...
	const targetVal = !neighborBlock.replaceability().isReplaceable() and !neighborBlock.transparent() and (blockBaseModelIndex == neighborBaseModelIndex or neighborModel.isNeighborOccluded[neighbor.reverse().toInt()]);
