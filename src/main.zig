...
pub const KeyBoard = struct {
	...
	pub var keys = [_]Window.Key {
		...
		.{.name = "acquireSelectedBlock", .mouseButton = c.GLFW_MOUSE_BUTTON_MIDDLE, .pressAction = &game.pressAcquireSelectedBlock, .releaseAction = &game.releaseAcquireSelectedBlock},
