...
pub const Mat4f = struct { // MARK: Mat4f
	...
	// copied from zmath library (MIT License) : https://github.com/zig-gamedev/zmath/blob/3a5955b2b72cd081563fbb084eff05bffd1e3fbb/src/root.zig#L2536
	pub fn inverse(m: Mat4f) Mat4f {
		const mt = transpose(m);
		var v0: [4]Vec4f = undefined;
		var v1: [4]Vec4f = undefined;

		v0[0] = swizzle(mt.rows[2], .x, .x, .y, .y);
