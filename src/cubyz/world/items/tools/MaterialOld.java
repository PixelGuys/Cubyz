 ...
 */
 ...
 @Deprecated
public class MaterialOld implements RegistryElement {
	...
	public MaterialOld(int heDur, int bDur, int haDur, float dmg, float spd) {
	...
	public MaterialOld(Resource id, List<Modifier> modifiers, HashMap<Item, Integer> items, int heDur, int bDur, int haDur, float dmg, float spd, int lvl) {
		this.id = id;
