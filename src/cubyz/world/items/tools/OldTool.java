 ...
 */
@Deprecated
public abstract class OldTool extends Item {
	...
	public OldTool(MaterialOld head, MaterialOld binding, MaterialOld handle, float speed, float damage) {
		this.head = head;
	...
	public static OldTool loadFrom(JsonObject json, CurrentWorldRegistries registries) {
