...
public class MainRenderer {
	...
	public void render() {
		...
		if (Cubyz.world != null) {
			...
			float lightY = ((float)Cubyz.world.getGameTime() % World.DAY_CYCLE) / (float) (World.DAY_CYCLE/2) - 1f;
			float lightX = ((float)Cubyz.world.getGameTime() % World.DAY_CYCLE) / (float) (World.DAY_CYCLE/2) - 1f;
