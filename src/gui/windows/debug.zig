...
pub fn render() void {
	...
	if (main.game.world != null) {
		...
		y += 8;
		draw.print("Game Time: {} Day Time: {} Day Phase: {}", .{main.game.world.?.gameTime.load(.monotonic), main.game.world.?.dayTime.dayTime, main.game.world.?.dayTime.dayPhase}, 0, y, 8, .left);
		y += 8;
