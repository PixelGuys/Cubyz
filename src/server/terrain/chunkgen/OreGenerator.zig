...
var ores: []main.block_manager.Ore = undefined;
...
pub fn init(parameters: ZonElement) void {
	_ = parameters;
	ores = main.block_manager.ores.items;
}
...
fn considerCoordinates(ore: *const main.block_manager.Ore, relX: f32, relY: f32, relZ: f32, chunk: *main.chunk.ServerChunk, startSeed: u64) void {
	...
	var seed = startSeed ^ @as(u32, @bitCast(ore.maxHeight)) ^ @as(u32, @bitCast(ore.size)) ^ @as(u32, @bitCast(main.block_manager.Block.blockHealth(.{.typ = ore.blockType, .data = 0})));
