	...
	pub const Sign = struct {
		...
		pub fn renderAll(projectionMatrix: Mat4f, ambientLight: Vec3f, playerPos: Vec3d) void {
			...
			outer: for(StorageClient.storage.dense.items) |signData| {
				...
				_ = mesh;
				const light: [4]u32 = @splat(0); // TODO: main.renderer.chunk_meshing.PrimitiveMesh.getLight(mesh, signData.blockPos -% Vec3i{mesh.pos.wx, mesh.pos.wy, mesh.pos.wz}, 0, quad);
