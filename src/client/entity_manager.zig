...
pub fn init() void {
	...
	modelTexture = main.graphics.Texture.initFromFile("assets/cubyz/entityModels/textures/snale.png");
	const modelFile = main.files.cwd().read(main.stackAllocator, "assets/cubyz/entityModels/models/snale.obj") catch |err| blk: {
