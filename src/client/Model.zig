...
pub const Model = struct {
    ...
    pub fn generateGraphics(self:*Model,modelID:[]const u8)void{
        const quadInfos = main.assets.rawEntityModelData.get(modelID) orelse unreachable;
