...
public class JungleTransformation extends Transformation {
	...
	public Matrix4f getOrtoProjModelMatrix(Spatial gameItem, Matrix4f orthoMatrix) {
		...
		modelMatrix.identity().translate(gameItem.getPosition()).rotateX(-DEGTORAD * rotation.x)
				.rotateY(-DEGTORAD * rotation.y).rotateZ(-DEGTORAD * rotation.z).scale(gameItem.getScale());
