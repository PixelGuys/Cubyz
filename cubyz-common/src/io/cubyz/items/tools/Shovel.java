...
public class Shovel extends Tool {
	...
	public Shovel(Material head, Material binding, Material handle) {
		...
		texturePath = "assets/cubyz/textures/items/parts/"+handle.getRegistryID().getID()+"_handle.png#assets/cubyz/textures/items/parts/"+head.getRegistryID().getID()+"_shovel_head.png#assets/cubyz/textures/items/parts/"+binding.getRegistryID().getID()+"_binding.png";
	}
	...
	private static float calculateDmg(Material head, Material binding, Material handle) {
		return head.damage;// A shovel is bad for combat.
	}
