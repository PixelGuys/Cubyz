...
public class Axe extends Tool {
	...
	public Axe(Material head, Material binding, Material handle) {
		...
		texturePath = "assets/cubyz/textures/items/parts/"+handle.getRegistryID().getID()+"_handle.png#assets/cubyz/textures/items/parts/"+head.getRegistryID().getID()+"_axe_head.png#assets/cubyz/textures/items/parts/"+binding.getRegistryID().getID()+"_binding.png";
	}
	...
	private static float calculateDmg(Material head, Material binding, Material handle) {
		return head.damage + 2;// An axe is better than shovel and pickaxe
	}
